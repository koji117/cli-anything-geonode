...
class GeoNodeClient:
    ...
    def update_dataset(
        ...
        *,
        ...
        time_regex=None,
        featureinfo_custom_template=None,
        data=None,
        metadata=None,
        # Dates
        date=None,
        ...
        advertised=None,
        metadata_only=None,
        metadata_uploaded_preserve=None,
        # Misc
        attribution=None,
        doi=None,
        language=None,
        ...
        **kwargs,
        ...
        """
        _locals = {
            k: v for k, v in locals().items() if k not in ("self", "pk", "kwargs")
        }
    ...
    def async_create_resource(
        ...
        **kwargs,
        ...
        _locals = {
            ...
            if k not in ("self", "resource_type", "kwargs")
        }
        resp = self._post(
            f"resources/create/{resource_type}",
            json=self._build_payload(_locals, kwargs),
        )
        return resp.json()
    ...
    def async_update_resource(
        ...
        **kwargs,
        ...
        resp = self._put(
            f"resources/{pk}/update", json=self._build_payload(_locals, kwargs)
        )
        return resp.json()
    ...
    def create_upload_size_limit(
        ...
        **kwargs,
        ...
        _locals = {k: v for k, v in locals().items() if k not in ("self", "kwargs")}
        resp = self._post(
            "upload-size-limits", json=self._build_payload(_locals, kwargs)
        )
        return resp.json()
    ...
    def create_upload_parallelism_limit(
        ...
        **kwargs,
        ...
        _locals = {k: v for k, v in locals().items() if k not in ("self", "kwargs")}
        resp = self._post(
            "upload-parallelism-limits", json=self._build_payload(_locals, kwargs)
        )
        return resp.json()
    ...
    def update_harvester(
        ...
        **kwargs,
        ...
        resp = self._patch(
            f"harvesters/{pk}", json=self._build_payload(_locals, kwargs)
        )
        return resp.json()
